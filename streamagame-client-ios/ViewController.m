...
#define HOSTNAME @"test.example.com"
#define RTSPURL @"rtsp://test.example.com:8554/desktop"
...
- (void)displayRtspStream {
    ...
    if (avformat_open_input(&pFormatCtx, [RTSPURL UTF8String], NULL, &opts) !=0 ) {
...
- (void)sendTouchMessage:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event stillTouched:(bool)clicked currentlyMoving:(bool)moving
{
    ...
    [self.socket sendData:data toHost:HOSTNAME port:8555 withTimeout:-1 tag:msgCounter++];
}
@end
