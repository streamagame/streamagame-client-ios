...
//  VideoGLView.m
//  Lightdroid
//  This file borrows heavily from the kxmovie sample project.
//
...
(
 ...
 void main()
 {
     ...
     highp float r = 1.164383 * y                   + 1.596027 * v;
     highp float g = 1.164383 * y - 0.391762 * u    - 0.812968 * v;
     highp float b = 1.164383 * y + 2.017232 * u;
...
#pragma mark - Object setup and teardown

// This makes sure that self.layer will be created as an object of the CAEAGLLayer by UIKit
+ (Class) layerClass
{
...
#pragma mark - Frame submission for rendering
